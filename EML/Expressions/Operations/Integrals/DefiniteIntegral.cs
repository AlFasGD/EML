...
namespace EML.Expressions.Operations.Integrals
{
    ...
    public class DefiniteIntegral : Integral
    {
        ...
        public RealNumericExpression Start;
        /// <summary>The end of the definite integral.</summary>
        public RealNumericExpression End;
        ...
        public DefiniteIntegral(RealNumericExpression start, RealNumericExpression end, Function function, string variableName)
