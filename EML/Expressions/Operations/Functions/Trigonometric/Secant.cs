...
namespace EML.Expressions.Operations.Functions.Trigonometric
{
    ...
    public class Secant : FunctionOperation
    {
        ...
        public override Expression Differentiate(Expression expression) => Argument.Differentiate(expression) * new Sine(Argument as INumericExpression) / new Exponentation(new Cosine(Argument as INumericExpression), new RealConstant(2));
    }
}
