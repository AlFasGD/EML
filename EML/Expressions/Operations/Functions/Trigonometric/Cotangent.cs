...
namespace EML.Expressions.Operations.Functions.Trigonometric
{
    ...
    public class Cotangent : FunctionOperation
    {
        ...
        public override Expression Differentiate(Expression expression) => Argument.Differentiate(expression) / new Exponentation(new Sine(Argument as INumericExpression), new RealConstant(2)) * new RealConstant(-1);
