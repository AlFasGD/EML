...
namespace EML.Sets
{
    ...
    public class RealNumberInterval
    {
        ...
        public RealNumericExpression Left { get; set; }
        public RealNumericExpression Right { get; set; }
        public bool ClosedLeft { get; set; }
        public bool ClosedRight { get; set; }

        public RealNumberInterval(RealNumericExpression left, RealNumericExpression right, bool closedLeft, bool closedRight)
        {
        ...
        public RealNumberInterval(RealNumericExpression left, RealNumericExpression right, bool closedLeft, bool closedRight, ISpecialNumberSet s)
        {
            IntervalDomain = s;
            IsCompleteIntervalDomain = false;
            Left = left;
